...
#循环读图
for path in getAllImages(r'I:\\dataset\\ILSVRC17\\ILSVRC\\Data\\DET\\test1'):
    #读图
    img = Image.open(path)
    #显示
    plb.imshow(img)
    ...
    corner = plb.ginput(4)
    #顺时针取点求解
    left = (corner[0][0] + corner[3][0])/4
    top = (corner[1][1] + corner[0][1])/4
    reight = (corner[1][0] + corner[2][0])/4
    under = (corner[3][1] + corner[2][1])/4
